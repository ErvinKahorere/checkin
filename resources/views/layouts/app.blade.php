...
<body class="login" onload="myFunction()" id="login">
...
function myFunction() {
 ...
 document.getElementById('fingerprint').value = uid;

//  var sql = "INSERT INTO `businesses` (`id`, `name`, `phone`, `email`, `location`, `created_at`, `updated_at`) VALUES ('4', 'My  Business', '081324647', 'my@third.om', 'Windhoek', NULL, NULL);";
