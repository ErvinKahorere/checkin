...
@section('content')
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
           ...
           <form method="POST" action="{{ route('store-business') }}" class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                        @csrf
           ...
           <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    ...
                    <div class="wizard flex flex-col lg:flex-row justify-center px-5 sm:px-0">
                        ...
                        <div class="intro-x mt-8">
                            ...
                            <input type="text" class="intro-x login__input input input--lg border border-gray-300 block" placeholder="Business Name" id="name" name="name">
                            @error('name')
                                ...
                                <input type="text" class="intro-x login__input input input--lg border border-gray-300 block mt-4" placeholder="Phone Number"  id="phone" name="phone">                         
                            ...
                            <input type="text" class="intro-x login__input input input--lg border border-gray-300 block mt-4" placeholder="Physical Address"  id="location" name="location">                    
