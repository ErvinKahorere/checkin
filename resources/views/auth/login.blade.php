    ...
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <a href="" class="-intro-x flex items-center pt-5">
                ...
                <div class="my-auto">
                    <img alt="CheckIn" class="-intro-x w-1/2 -mt-16" src="{{ asset('dist/images/illustration.svg') }}">
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Sign in to CheckIn. <br> Keep track & <br> help stop Covid-19</div>
                ...
                <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-8">
                        ...
                        @csrf
                            ...
                            <input type="text" id="input-email" value="your@email.com" class="intro-x login__input input input--lg border border-gray-300 block" placeholder="Email">
